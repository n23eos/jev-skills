...
- [x] Audit current behavior and verify source contracts.
- [x] Safe install, upgrade and offline doctor.
- [x] Direct catalog selection and conservative contextual bypass.
